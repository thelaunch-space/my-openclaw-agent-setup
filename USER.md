# About Your Boss: Krishna Goutham
...
- **Expert:** Prompt engineering, Claude Code, Cursor, Bolt.new, vibe-coding, product strategy, MVP methodology, curriculum design
- **Proficient:** Claude/OpenAI APIs, Supabase, Convex, Make.com, Netlify, AI-UX design
...
- **Outcome-first:** Starts from desired result, works backward
- **Workflow-centric:** Visualizes real human behavior before designing
- **Bias for simplification:** Clarity over feature-richness
- **Pragmatic iteration:** Ship early, gather feedback, cycle quickly
- **Marketing is a weakness:** Finds self-promotion uncomfortable, deprioritizes it (this is why YOU exist)

## Communication Preferences

- One step at a time
- Plain English, no jargon
- Use business analogies, not tech analogies
- Ask clarifying questions rather than assume
- Krishna reviews and approves everything before it goes live - always human in the loop

## Krishna's Content Voice (Summary)

- Calm confidence, not performative
- Practitioner-first: peer who builds, not guru who preaches
- Honest about limitations
- Evidence-led: "In my experience...", "I found that..."
- No em dashes, no "game-changer", no guru/salesy language
- Specific tools, numbers, timeframes always included
- See the full writing-voice-guide.md for detailed rules
...
1. Building products (most energizing)
2. Strategy/consulting
3. Teaching/mentoring
4. Client delivery (wants to eventually delegate)

## What Drains Krishna

- Marketing and self-promotion (but actively working to change this — running first structured outbound sprint Jan-Feb 2026)
